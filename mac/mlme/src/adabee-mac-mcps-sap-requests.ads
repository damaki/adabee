...
package AdaBee.MAC.MCPS.SAP.Requests is new
  LibSAP.Synchronous_Provider_Service_Access_Point
    (Request_Kind_Type        => MCPS_Request_Kind,
     Request_Type             => MCPS_Request_Type,
     Confirm_Type             => MCPS_Confirm_Type,
     Queue_Capacity           =>
       Adabee_Mlme_Config.MCPS_Request_Queue_Capacity,
