...
--
with AdaBee.MAC.MCPS.SAP.Requests; use AdaBee.MAC.MCPS.SAP.Requests;

procedure AdaBee.MAC.MCPS.SAP.Wait_For_Confirm
...
--  primitive has been posted by the MCPS-SAP.
